...
parser = argparse.ArgumentParser(description='Compile list of infer_images into a pickled object for training')
...
def get_special_type():
    ...
    font_list = [f[:f.find('.result.jpg')] for f in font_list]
    '''
