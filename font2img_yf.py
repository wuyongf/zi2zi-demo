...
def font2font(src, dst, charset, char_size, canvas_size,
             x_offset, y_offset, sample_count, sample_dir, label=0, filter_by_hash=True, count=0):

    # print('yf: char_size: ' , char_size)
    # print('yf: canvas_size: ' , canvas_size)
    # print('yf: x_offset: ' , x_offset)
    # print('yf: y_offset: ' , y_offset)
    # print('yf: sample_count: ' , sample_count)
...
def imgs2imgs(src, dst, canvas_size, sample_count, sample_dir):
    ...
    count = 0
    # For example
    # source infer_images are 南~0号字体1，南~0号字体2，京~0号字体，市~0号字体，长~0号字体，江~0号字体，大~0号字体，桥~0号字体
    # make sure all the source infer_images are same font, or at least, very close fonts.
    # target infer_images are 南~1号字体，京~1号字体，市~1号字体，长~2号字体
...
parser.add_argument('--count', type=int, default=0, required=True)
...
if __name__ == "__main__":
    ...
    if args.mode == 'font2font':
        ...
        font2font(args.src_font, args.dst_font, charset, args.char_size,
                  ...
                  args.sample_count, args.sample_dir, args.label, args.filter, args.count)
